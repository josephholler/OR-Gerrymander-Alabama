...
```
Notice that the coordinate reference system was WGS 1984, but should be NAD 1983 to match the study CRS.
Transform the CRS.
Also, calculate the percentage of the population that is Black
...
District 7 really is gerrymandered (packed African American), but the circumcircle method does not find it so.
District 5 is not really gerrymandered, even though the circumcirle does find it so.
...
Convex hull and minimum bounding circle exhibit a positve correlation, with the exception of District 5.
